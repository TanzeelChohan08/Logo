        ...
        >
            ...
            `      <View style={{ flex: 1, alignItems: "center", justifyContent: "center", gap: sizeHelper.calHp(50) }}>
                `        <View style={{ marginBottom: sizeHelper.calHp(30) }}>
                    <View style={{ width: "86%" }}>
                        <CustomText
                            ...
                            textAlign={"center"}
                            text={translate(lang, "Password Reset", "إعادة تعيين كلمة المرور")}
                    ...
                    <View>
                        <CustomText
                            ...
                            text={
                                translate(
                                    lang, "Enter code that we have sent to your email ",
                ...
                <CustomInput
                    ...
                    label={translate(lang, "Enter Email", "أدخل الرمز")}
                ...
                <CustomButton
                    ...
                    text={translate(lang, "Reset Password", "استمر")}
                />
            </View>
            <View
                style={{
