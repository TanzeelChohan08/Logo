    ...
    >
      ...
      {label && (
        ...
        >
          <CustomText
            ...
            size={21}
            color={theme.text}
            fontFam={fonts.Oswald_Bold || labelfontFam}
            style={{
      ...
      >
        {leftSource && (
          <Image
            ...
            style={{
              ...
              tintColor: tintColor || theme.grey
            }}
            resizeMode={"contain"}
          />
        )}
        ...
        <TextInput
          ...
          multiline={multiline}
          placeholderTextColor={placeholderTextColor || theme.grey}
        ...
        {rightSource && (
          ...
          >
            <Image
              source={rightSource}
              style={{
                width: sizeHelper.calWp(rightSourceSize || 36),
                height: sizeHelper.calWp(rightSourceSize || 36),
